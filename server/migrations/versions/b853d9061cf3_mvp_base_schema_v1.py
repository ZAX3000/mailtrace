...
Revision ID: b853d9061cf3
Revises: 
Create Date: 2025-10-28 08:12:48.847902
...
def upgrade():
    ...
    op.create_index('idx_matches_date', 'matches', ['user_id', 'crm_job_date'], unique=False)
